...
$('d-bg').onclick = () => {
  ...
  paintToggles();
  toast(DSP.bg ? 'Background priority on — DSP unavailable' : 'DSP available');
};
...
AURA.onGraphNeeded = async () => { /* graph attaches only when DSP is switched on */ };
